...
function FindBuff(obuff, unit, item)
    ...
    local c = nil;
    for i = 1, 32 do
        -- Turtle WoW increased the buff cap to 32
        tooltip:SetOwner(UIParent, "ANCHOR_NONE");
    ...
    c = nil;
    for i = 1, 64 do
        -- Turtle WoW increased the debuff cap to 64
        tooltip:SetOwner(UIParent, "ANCHOR_NONE");
